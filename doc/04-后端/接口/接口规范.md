...
#### 获取用户任务历史
```http
GET /接口/v1/users/me/tasks?page=1&limit=20&type=pdf_to_word
Authorization: Bearer <token>
    ...
    "output_files": [
      {
        ...
        "name": "output.docx",
        "size": 1536000,
        "download_url": "/接口/v1/files/1002/download"
      }
    ],
    "progress": 100,
    "result_info": {
...
```http
GET /接口/v1/users/me/tasks?page=1&limit=20
```
